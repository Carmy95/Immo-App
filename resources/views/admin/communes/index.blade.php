    ...
    <div class="col-md-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <h4 class="mt-0 header-title">Nos Communes</h4>
                <div class="row">
                    <div class="col-md-4"><a href="{{ route('communes.create') }}" class="btn btn-outline-primary waves-effect waves-light"><i class="ti-plus"></i> Ajouter</a></div>
                    <div class="col-md-8">
                        <form action="#">
                            <div class="row">
                        ...
                        @if($data->isNotEmpty())
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ route('communes.edit',$item->id) }}" title="Modifier" class="btn btn-outline-warning waves-effect waves-light"><i class="ti-pencil-alt"></i></a></td>
                                    <td><form method="post" action="{{ route('sliders.destroy', $item->id) }}"
                                        onsubmit="return confirm('Etre vous sûre de vouloir Supprimer cette commune ?') ">
