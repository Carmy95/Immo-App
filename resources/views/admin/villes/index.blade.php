    ...
    <div class="col-md-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4"><a href="{{ route('villes.create') }}" class="btn btn-outline-primary waves-effect waves-light"><i class="ti-plus"></i> Ajouter</a></div>
                    <div class="col-md-8">
                        <form action="#">
                            <div class="row">
                ...
                <table class="table table-bordered table-hover" style="text-align: center">
                    ...
                    <tbody>
                        @if ($data->isNotEmpty())
                            @foreach ($data as $item )
                                <tr>
                                    ...
                                    <td><form method="post" action="{{ route('villes.destroy', $item->id) }}"
                                        onsubmit="return confirm('Etre vous sûre de vouloir Supprimer cette ville ?') ">
                        ...
                        @else
                            <tr>
                                <th colspan="4">Aucne ville enregistré pour le moment !!</th>
                            </tr>
                        @endif
                    </tbody>
                </table>
