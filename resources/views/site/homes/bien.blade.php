...
<div class="featured">
    <div class="container">
                ...
                <div class="listing">
                    <div class="listing_image">
                        ...
                        <div class="tags d-flex flex-row align-items-start justify-content-start flex-wrap">
                            <div class="tag tag_house"><a href="listings.html">Maison</a></div>
                            <div class="tag tag_sale"><a href="listings.html">A vendre</a></div>
                        </div>
                        <div class="tag_price listing_price">10 000 000 Fcfa</div>
                    </div>
                    <div class="listing_content">
                        <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                            <img src="images/icon_1.png" alt="">
                            <a href="single.html">Cocody 8e Tranche</a>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="listing">
                    <div class="listing_image">
                        ...
                        <div class="tags d-flex flex-row align-items-start justify-content-start flex-wrap">
                            <div class="tag tag_house"><a href="listings.html">Appartement</a></div>
                            <div class="tag tag_rent"><a href="listings.html">A louer</a></div>
                        </div>
                        <div class="tag_price listing_price">320000 fCFA</div>
                    </div>
                    <div class="listing_content">
                        <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                            <img src="images/icon_1.png" alt="">
                            <a href="single.html">Marcory Zone 4</a>
                        </div>
                        <div class="listing_info">
                            <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                <li class="property_area d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="col-lg-4">
                <div class="listing">
                    <div class="listing_image">
                        ...
                        <div class="tag_price listing_price">375 255 000 fcfa</div>
                    </div>
                    <div class="listing_content">
                        <div class="prop_location listing_location d-flex flex-row align-items-start justify-content-start">
                            <img src="images/icon_1.png" alt="">
                            <a href="single.html">Rue 5, Avenue 25 Treichville</a>
                        </div>
                        <div class="listing_info">
                            <ul class="d-flex flex-row align-items-center justify-content-start flex-wrap">
                                <li class="property_area d-flex flex-row align-items-center justify-content-start">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="listing">
                    <a href="#"><div class="tag_price listing_price">Voir tous les biens</div></a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="listing">
